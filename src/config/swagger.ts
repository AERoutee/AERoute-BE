    ...
    schemas: {
      ...
      RouteOption: {
        ...
        properties: {
          ...
          reductionFromFastestPercent: { type: 'integer', minimum: 0 },
          reductionPercent: { type: 'integer', minimum: 0 },
      ...
      RouteComparison: {
        ...
        properties: {
          ...
          cleanestDeparture: { type: 'integer', enum: [0, 30, 60], description: 'Window containing the minimum modeled exposure among all available routes.' },
